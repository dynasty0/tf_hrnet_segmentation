...
class HRFront():
    ...
    def __init__(self, num_channels, bottlenect_channels, output_channels, num_blocks, strides):
        self.scope = 'HR_FRONT'
    ...
    def forward(self, input):
        with tf.variable_scope(self.scope):
            ...
            _out = slim.conv2d(_out, num_outputs=self.num_channels, kernel_size=[3, 3],
                               stride=self.strides, activation_fn=tf.nn.relu, normalizer_fn=batch_norm)
